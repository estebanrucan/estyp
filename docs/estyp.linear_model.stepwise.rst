...
.. function:: both_selection(formula, data, model, max_iter, **kwargs)
    ...
    :param fit_kwargs: Additional keyword arguments to be passed to the fit() method.
...
.. function:: forward_selection(y, data, model, alpha, **kwargs)
    ...
    :type alpha: float
    :param formula_kwargs: Additional keyword arguments to be passed to the model.from_formula() method. Defaults to :code:`{}`.
    :type formula_kwargs: dict
    :param fit_kwargs: Additional keyword arguments to be passed to the fit() method. Defaults to :code:`{"disp": 0}`.
    :type fit_kwargs: dict
    :return: A string representing the final model formula.
    :rtype: str
